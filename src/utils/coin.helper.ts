...
export function calculate_daily_streak(user_streak: number): number {
	if (user_streak / 10) {
 ...
 */
export function calculate_coins(
	streaks: Set<CrewStreak>,
	user_streak: number,
	date?: Date
): Promise<{
	coins: number;
